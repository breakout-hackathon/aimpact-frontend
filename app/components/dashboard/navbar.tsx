            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 w-40 lg:w-60 rounded-full bg-gray-100 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500/50 text-sm transition-all duration-200 text-white"
                />
              </div>
            </nav>
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="relative mt-4">
              ...
              <input
                type="text"
                placeholder="Search projects..."
                className="w-full pl-10 pr-4 py-2 rounded-full bg-gray-100 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500/50 text-sm text-white"
              />
            </div>
          </div>
        </motion.div>
